...
///////////////////////////////////////////////////////////////////////////
    ...
    private fun restartGame(score_m: Int) {
        getLocation { location ->
            if (location != null) {
                ScoreManagerSingleton.insert_score(score_m, location) 
            } else {
                Log.d("MainActivity", "Location not available, inserting score without location.")
                ScoreManagerSingleton.insert_score(score_m, LatLng(32.0968509,34.6317778))    
            }
    ...
    private fun crash_sound(){
        val crash_sound = MediaPlayer.create(this, R.raw.crash) 
    ...
    private fun increase_distance() {
        ...
        odometer.text = "Distance: ${distance_meters}" 
    }
        ...
        coin_icon.animate()
            ...
            .setUpdateListener { animation -> 
                if (car.isHit(coin_icon)) {
                    increase_coins()
                    coin_icon.visibility = View.GONE 
                    animation.cancel()
                }
            }
            .withEndAction {
